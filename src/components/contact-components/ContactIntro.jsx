      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-16 px-6 md:px-12">
        ...
        <div className="lg:col-span-2 flex flex-col justify-center">
          ...
          <h2 className="text-2xl md:text-4xl font-bold tracking-tighter leading-[0.9] text-[#172B36] mb-6">
            Let’s Build <br />
            <span className="text-[#FF9932]">Something Together</span>
          </h2>

          {/* Decorative Line */}
          <div className="w-24 h-1.5 bg-[#FF9932] mb-8 rounded-full"></div>
          ...
          <div className="space-y-6">
            ...
            {/* Phone */}
            <div className="flex items-start gap-4 p-5 rounded-2xl bg-[#F1F6F4]/60 border border-[#114C5A]/5 hover:border-[#FF9932]/20 transition-all duration-300">
              <div className="w-11 h-11 rounded-xl bg-white shadow-sm flex items-center justify-center text-[#FF9932]">
                <Phone size={18} />
              </div>
            ...
            {/* Business Hours */}
            <div className="flex items-start gap-4 p-5 rounded-2xl bg-[#F1F6F4]/60 border border-[#114C5A]/5 hover:border-[#FF9932]/20 transition-all duration-300">
              <div className="w-11 h-11 rounded-xl bg-white shadow-sm flex items-center justify-center text-[#FF9932] relative">
                <Clock size={18} />
